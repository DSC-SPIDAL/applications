...
cp=${cp}:../../bin/fusheng_wang_bio-1.0-SNAPSHOT-jar-with-dependencies.jar:../../target/pathology_image_dat-jar-with-dependencies.jar

dataFile=../../sampledata/singleimage.data
points=2000
dimension=96
outFile=../../sampledata/out.bin
